...
typedef enum d_grpc_dualstack_mode {
...
extern int d_grpc_forbid_dualstack_sockets_for_testing;
...
grpc_error* d_grpc_create_dualstack_socket(const grpc_resolved_address* addr,
